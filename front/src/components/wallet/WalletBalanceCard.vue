...
<template>
  ...
  >
    <div class="flex items-center justify-between mb-2">
      ...
      <button
        type="button"
        class="text-[12px] font-medium text-gray-400 hover:text-gray-600 flex items-center gap-0.5 transition-colors"
    ...
    <div class="mb-6 pt-1">
      <button
        ...
        @click="$emit('history')"
      >
        <History :size="15" class="text-gray-400 group-hover:text-gray-600" />
        <span>이용내역 보기</span>
        <ChevronRight
          :size="14"
          class="text-gray-400 group-hover:translate-x-0.5 transition-transform"
        />
      </button>
    </div>
